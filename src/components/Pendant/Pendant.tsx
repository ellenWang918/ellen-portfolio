...
export type PendantProps = { isOn?: boolean; label?: string; id?: string; className?: string };
...
export function Pendant({ isOn = false, label, id, className }: PendantProps = {}) {
